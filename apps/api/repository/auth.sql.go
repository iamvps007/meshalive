...
func (q *Queries) GetUserFirstWorkspace(ctx context.Context, userID uuid.UUID) (GetUserFirstWorkspaceRow, error) {
	row := q.db.QueryRowContext(ctx, getUserFirstWorkspace, userID)
